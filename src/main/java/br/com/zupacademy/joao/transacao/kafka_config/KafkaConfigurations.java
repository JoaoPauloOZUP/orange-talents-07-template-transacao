package br.com.zupacademy.joao.transacao.kafka_config;
...
public class KafkaConfigurations {
    ...
    public KafkaConfigurations(KafkaProperties properties) {
    ...
    @Bean
    public ConsumerFactory<String, TransacaoInput> transactionConsumerFactory() {
        StringDeserializer stringDeserializer = new StringDeserializer();
        JsonDeserializer<TransacaoInput> jsonDeserializer = new JsonDeserializer<>(TransacaoInput.class, false);

        return new DefaultKafkaConsumerFactory<>(consumerConfigurations(), stringDeserializer, jsonDeserializer);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransacaoInput> kafkaListenerContainerFactory() {
